...
<body>
 <div class="col-lg-12">
 <h3 class="page-header">Tampilan Data Masuk Proposal</h3>
 
<script>
function cari(){
	document.location='?halaman=rekapproposal&cari=' + document.getElementById("katakunci").value;
}
</script>
<div class="col-lg-12">
...
<br>
<div class="col-lg-1">
 <a href="printproposal.php" class="btn btn-primary form-control" target="blank">Print</a>
</div>
<br>
<br>
...
while ($tampil=mysqli_fetch_array($data)){
	...
	<tr align='center'>
		...
		<td style='vertical-align:middle' align=center>
			<a href='?halaman=rekapproposal&delete=$tampil[nama_kegiatan]' class='btn btn-warning btn-xs' onclick='return confirm(".'"Apakah anda Yakin ?"'.")'>Delete</a>
		</td>	
	</tr>
	";
	$no=$no+1;
